...
const buildInitialBooksState = () => {
  const book1 = new Book('The Phoenix Project', 'Gene Kim, Kevin Behr, and George Spafford', 25);
  const book2 = new Book('The Lost Symbol', 'Dan Brown', 25);
...
export class BooksStore {
  ...
  public books$ = this._books$.asObservable().pipe(map(mapToArrayOfValues));
